...
The automated college admission system is providing the SSC (Secondary School Certifacte) passed students a user friendly platform to apply for their desired colleges. The current automated system is serving from the academic year 2007-18 ??. 
...
with the landing page of the web application of XI Admission System \cite{xiaddmissionlandingpage}. The students then need to get into the system using their SSC Roll No, Board, Passong Year and Registration No. After getting into the system, at first the applying student need to verify the contact no he have submitted during the payment procedure.   
  which is shown in Figure \ref{fig:screenshots} shows the 
...
\begin{itemize}
	\item We plan to load the system with a maximum hourly rate of 20000 application.
